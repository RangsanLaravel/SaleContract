...
namespace SaleContractAPI.DataAccess
{
  ...
  AND TMN_FLG ='N'"
        ...
        public async ValueTask<email_detail> GET_STATUS_BY_ID_JOB(string ID)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
                Connection = this.sqlConnection,
                CommandText = $@"SELECT [ID]
      ,(select NAME from [{DBENV}].dbo.[tbt_company_detail_job] WHERE ID =company_id AND TMN_FLG ='N')AS customername
      ,(SELECT STATUS_DESCRIPTION FROM [{DBENV}].dbo.[tbm_substatus] WHERE ACTIVE_FLG =1 AND STATUS_TYPE='SALE' AND STATUS_CODE=d.STATUS_CODE ) AS status
      ,[fsystem_id]
      ,[fsystem_dt]
      ,[tmn_flg]
      ,[tmn_dt]
      ,[remark]
  FROM [{DBENV}].dbo.[tbt_sale_status_job] d
  WHERE ID =@ID
  AND TMN_FLG ='N'"
            };
            sql.Parameters.AddWithValue("@ID", ID);
...
ORDER BY Priority_SEQ ASC"
  ...
  AND st.ID =@idremark"
        ...
        public async ValueTask<UserInfo> GET_EMAIL_JOB(string ID_REMARK_UPLINE)
        {
            SqlCommand command = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
      ...
      em.*
  FROM [{DBENV}].dbo.[tbm_employee] em
  INNER JOIN [{DBENV}].dbo.[tbt_remark_status_job] st on st.remark_id =em.user_id
  WHERE em.status =1
  AND st.TMN_FLG ='N'
  AND st.ID =@idremark"
            };
...
ORDER BY tbtst.FSYSTEM_DT ASC"
      ...
      ,tbtst.tmn_dt
      ,tbtst.remark
  FROM [{DBENV}].dbo.[tbt_sale_status_job] tbtst
  INNER JOIN [{DBENV}].dbo.[tbm_substatus] sub on sub.STATUS_CODE= tbtst.STATUS_CODE
  WHERE tbtst.tmn_flg='N'
  AND sub.ACTIVE_FLG =1
  AND sub.STATUS_TYPE='SALE'
...
ORDER BY cmp.NAME ASC
   "
      ...
      ,[tmn_dt]
	  ,(SELECT Priority_description FROM [{DBENV}].dbo.[tbm_priority] WHERE TMN_FLG ='N' AND ID= cmp.Priority) as Priority_description 
  FROM [{DBENV}].dbo.[tbt_company_detail_job] cmp
  WHERE TMN_FLG ='N'
  AND (@name IS NULL OR NAME like '%{condition.NAME}%')
  AND (@wner IS NULL OR Owner =@wner)
  AND  (@ID IS NULL OR ID =@ID)
...
ORDER BY ID_REMARK_UPLINE ASC"
        ...
        public async ValueTask<List<tbt_remark_status>> GET_tbt_remark_status_JOB(string IDSTATUS)
        {
            SqlCommand command = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
      ...
      ,[TMN_FLG]  
,ord_group
FROM [{DBENV}].dbo.tbt_remark_status_job 
WHERE TMN_FLG ='N' 
AND ID_STATUS_SALE=@ID_STATUS_SALE
AND ID_REMARK_UPLINE IS NULL
ORDER BY ID_REMARK_UPLINE ASC"
        ...
        public async ValueTask<List<tbt_remark_status>> GET_tbt_remark_status_UPLINE_JOB(string IDREMARK)
        {
            SqlCommand command = new SqlCommand
            {
                CommandType = System.Data.CommandType.StoredProcedure,
                Connection = this.sqlConnection,
                CommandText = @$"[{DBENV}].[dbo].[sp_get_remark_status_job]",
            };
            command.Parameters.AddWithValue("@ID", IDREMARK);
...
ORDER BY ID DESC"
        ...
        public async ValueTask<tbt_remark_status> GET_IDSTATUS_JOB(long UPLINEID)
        {
            SqlCommand command = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
...
ORDER BY ID DESC"
        ...
        public async ValueTask<tbt_remark_status> CHECK_UPLINE_FOR_GORUP_JOB(long UPLINEID)
        {
            SqlCommand command = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
...
;SELECT SCOPE_IDENTITY();"
     ...
     VALUES
        ...
        public async ValueTask<int> INSERT_TBT_COMPANY_DETAIL_JOB(company_detail condition)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
                Connection = this.sqlConnection,
                Transaction = this.transaction,
                CommandText = $@"INSERT INTO [{DBENV}].[dbo].[tbt_company_detail_job]
           ([NAME]
           ,[WEBSITE]
           ,[Contract]
           ,[Position]
...
;SELECT SCOPE_IDENTITY();"
        ...
        public async ValueTask<int> INSERT_TBT_SALE_STATUS_JOB(TBT_SALE_STATUS condition)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
                Connection = this.sqlConnection,
                Transaction = this.transaction,
                CommandText = $@"INSERT INTO [{DBENV}].[dbo].[tbt_sale_status_job]
           ([company_id]
           ,[status_code]
           ,[fsystem_id]
           ,[fsystem_dt]
     ...
     VALUES
        ...
        public async ValueTask INSERT_TBT_SALE_NOTIFICATION_JOB(tbt_sale_notification condition)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
                Connection = this.sqlConnection,
                Transaction = this.transaction,
                CommandText = $@"INSERT INTO [{DBENV}].[dbo].[tbt_sale_notification_job]
           (
           [company_id]
           ,[noti_dt]
           ,[create_dt])
     VALUES
        ...
        public async ValueTask<long> INSERT_TBT_REAMRK_STATUS_JOB(tbt_remark_status condition)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
                Connection = this.sqlConnection,
                Transaction = this.transaction,
                CommandText = $@"INSERT INTO [{DBENV}].[dbo].[tbt_remark_status_job]
           (
            [ID_STATUS_SALE]
           ,[REMARK]
           ,[REMARK_DT]
...
WHERE ID =@ID "
        ...
        public async ValueTask UPDATE_TBT_REAMRK_STATUS_GROUP_JOB(long group, long id)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
                Connection = this.sqlConnection,
                Transaction = this.transaction,
                CommandText = $@"UPDATE [{DBENV}].[dbo].[tbt_remark_status_job]
SET ORD_GROUP =@ord_group
WHERE TMN_FLG ='N'
AND id =@id
            "
        ...
        public async ValueTask UPDATE_OWNER_JOB(long id, string USERID)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
                Connection = this.sqlConnection,
                Transaction = this.transaction,
                CommandText = $@"UPDATE [{DBENV}].[dbo].[tbt_company_detail_job]
SET Owner=@Owner
WHERE  id =@id
            "
            };
        ...
        public async ValueTask UPDATE_TBT_COMPANY_JOB(TBT_SALE_STATUS condition)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
...
WHERE ID =@ID "
        ...
        public async ValueTask UPDATE_TBT_COMPANY_DETAIL_JOB(company_detail condition)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
...
WHERE ID =@ID "
        ...
        public async ValueTask UPDATE_TBT_COMPANY_DETAIL_STATUS_JOB(string STATUS, string ID)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
...
WHERE ID =@ID "
        ...
        public async ValueTask UPDATE_TBT_COMPANY_DETAIL_WON_JOB(string ID)
        {
            SqlCommand sql = new SqlCommand
            {
                CommandType = System.Data.CommandType.Text,
...
WHERE ID =@ID "
        ...
        public async ValueTask UPDATE_TBT_SALE_NOTIFICATION_JOB(string ID)
        {
            SqlCommand sql = new SqlCommand
            {
                ...
                Connection = this.sqlConnection,
                Transaction = this.transaction,
                CommandText = $@"UPDATE [{DBENV}].[dbo].[tbt_sale_notification_job]
                                SET accept_dt =GETDATE()
                                WHERE ID =@ID "
            };
            sql.Parameters.AddWithValue("@ID", ID);
        ...
        {
            SqlCommand cmd = new SqlCommand($"[{DBENV}].[dbo].[sp_duplicate_company_job]", this.sqlConnection);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Transaction = this.transaction;
            cmd.Parameters.AddWithValue("@ID", ID);
            cmd.Parameters.AddWithValue("@USERID", USERID);
